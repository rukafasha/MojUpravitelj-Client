        ...
        child: Column(  
          ...
          children: <Widget>[  
            SizedBox(
              ...
              child: TextFormField(
                ...
                validator: (String? value) {
                  return (value!.isEmpty) ? 'Enter the address for your building.' : null; 
                }
              ),
            ),  
            SizedBox(
            ...
            child: TextFormField(  
              ...
              validator: (String? value) {
                return (value!.isEmpty) ? 'Enter the number of appartmentsin your building.' : null; 
              } 
            ),), 
            ...
            children: [
              ...
              onPressed: () async {
                if(_formKey.currentState!.validate() && RoleUtil.HasRole("Company")){
                  var building = await AddBuilding(_addressController.text, _numbOfAppController.text);
